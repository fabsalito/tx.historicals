(function ($) {
    var methods = {
        ...
        , _contabilizarTexto: function () {
            var cantidadEscrita = properties.textoDefault.length;
            var porcentaje = (cantidadEscrita * 100) / properties.limiteCaracteres;
